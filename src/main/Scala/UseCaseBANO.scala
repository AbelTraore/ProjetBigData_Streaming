...
val configH = new  Configuration()
  ...
  val chemin_dest = new Path("C:\\Users\\abel\\Desktop\\Formation_BigDataStreaming_Juv\\Maitriser_spark_BigData_leadSpark\\ressources\\Sources")
  ...
  def main(args: Array[String]): Unit = {
    ...
    val  df_bano_brut = ss.read
      ...
      .option("header", "true")
      .schema(schema_bano)
      .csv("C:\\Users\\abel\\Desktop\\Formation_BigDataStreaming_Juv\\Maitriser_spark_BigData_leadSpark\\ressources\\Sources\\BANO complet csv\\full.csv")
    ...
    val  liste_departement = df_bano.select("code_departement")
      .distinct()
    ...
    liste_departement.foreach{
      x => df_bano.filter(col("code_departement") === x.toString)
        ...
        .csv("C:\\Users\\abel\\Desktop\\Formation_BigDataStreaming_Juv\\Maitriser_spark_BigData_leadSpark\\ressources\\Sources\\BANO complet csv\\bano" + x.toString)

        val chemin_source = new Path("C:\\Users\\abel\\Desktop\\Formation_BigDataStreaming_Juv\\Maitriser_spark_BigData_leadSpark\\ressources\\Sources\\BANO complet csv\\bano" + x.toString)
...
/*
    df_departement.foreach{
      dep => df_bano.filter(col("code_departement") === dep.toString)
        ...
        .option("header", "true")
        .mode(SaveMode.Overwrite)
        .csv("C:\\Users\\abel\\Desktop\\Formation_BigDataStreaming_Juv\\Maitriser_spark_BigData_leadSpark\\ressources\\Sources\\BANO complet csv\\bano" + dep.toString)

        val chemin_source = new Path("C:\\Users\\abel\\Desktop\\Formation_BigDataStreaming_Juv\\Maitriser_spark_BigData_leadSpark\\ressources\\Sources\\BANO complet csv\\bano" + dep.toString)
        fs.copyFromLocalFile(chemin_source, chemin_dest)
    }
*/
